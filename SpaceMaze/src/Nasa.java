...
public class Nasa extends ElementoBasico {
    ...
    public Nasa(String id, int nroPista, int linInicial, int colInicial, Tabuleiro tabuleiro, String senha, String mensagem, String dica) {
...
public void acao(ElementoBasico outro) {
    if (fechada) {
        ...
        if (senhaDigitada != null && senhaDigitada.toLowerCase().equals(senha.toLowerCase())) {
            leuPista = true;
            setImage(Tabuleiro.createImageIcon("nasa.jpg"));
